...
import com.example.myplanner.activity.MainActivity;
import com.example.myplanner.bottomSheetFragment.CreateTaskBottomSheetFragment;
import com.example.myplanner.database.DatabaseClient;
...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public SimpleDateFormat inputDateFormat = new SimpleDateFormat("dd-MM-yyyy", Locale.US);
    Date date = null;
